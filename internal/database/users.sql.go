...
SELECT id, email, hashed_password, created_at, updated_at, role FROM users WHERE email = $1
`
...
SELECT id, email, hashed_password, created_at, updated_at, role FROM users WHERE id = $1
`
